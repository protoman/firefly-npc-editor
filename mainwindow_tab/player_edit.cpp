...
void player_edit::fill_players_data()
{
    ...
    ui->players_tab_name->setText(QString(Mediator::get_instance()->player_list_v3_1[index].name));
    ui->players_tab_hp->setValue(Mediator::get_instance()->player_list_v3_1[index].HP);
    ui->players_tab_hasshield->setChecked(Mediator::get_instance()->player_list_v3_1[index].have_shield);
    ui->players_tab_maxshots->setValue(Mediator::get_instance()->player_list_v3_1[index].max_shots);
    ...
    ui->playerFace_comboBox->setCurrentIndex(ui->playerFace_comboBox->findText(QString(Mediator::get_instance()->player_list_v3_1[index].face_filename)));

    ui->player_sprite_w->setValue(Mediator::get_instance()->player_list_v3_1[index].sprite_size.width);
    ui->player_sprite_h->setValue(Mediator::get_instance()->player_list_v3_1[index].sprite_size.height);

    ui->player_hitarea_x->setValue(Mediator::get_instance()->player_list_v3_1[index].sprite_hit_area.x);
    ui->player_hitarea_y->setValue(Mediator::get_instance()->player_list_v3_1[index].sprite_hit_area.y);
    ui->player_hitarea_w->setValue(Mediator::get_instance()->player_list_v3_1[index].sprite_hit_area.w);
    ui->player_hitarea_h->setValue(Mediator::get_instance()->player_list_v3_1[index].sprite_hit_area.h);
    ui->can_slide_checkbox->setChecked(Mediator::get_instance()->player_list_v3_1[index].can_slide);

    common::fill_projectiles_combo(ui->chargedshot_combo);
    common::fill_projectiles_combo(ui->normalShot_comboBox);
    ui->chargedshot_combo->setCurrentIndex(Mediator::get_instance()->player_list_v3_1[index].full_charged_projectile_id);
    ui->normalShot_comboBox->setCurrentIndex(Mediator::get_instance()->player_list_v3_1[index].normal_shot_projectile_id);

    ui->canDoubleJumpCheckBox->setChecked(Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].can_double_jump);
    ui->CanAirDashCheckBox->setChecked(Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].can_air_dash);
    ui->canShotDiagonal->setChecked(Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].can_shot_diagonal);

    ui->simultaneousShots_spinBox->setValue(Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].simultaneous_shots);
...
void player_edit::on_player_graphics_combo_currentIndexChanged(const QString &arg1)
{
    ...
    if (_loading == false) {
        sprintf(Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].graphic_filename, "%s", arg1.toStdString().c_str());
        ui->player_preview_widget->update_sprites();
    }
}
...
void player_edit::on_player_sprite_w_valueChanged(int arg1)
{
    ...
    if (_loading == false) {
        Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].sprite_size.width = arg1;
        ui->player_preview_widget->update_sprites();
    }
}
...
void player_edit::on_player_sprite_h_valueChanged(int arg1)
{
    ...
    if (_loading == false) {
        Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].sprite_size.height = arg1;
        ui->player_preview_widget->update_sprites();
    }
}
...
void player_edit::on_normalShot_comboBox_currentIndexChanged(int index)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].normal_shot_projectile_id = index;
}

void player_edit::on_players_tab_movespeed_valueChanged(double arg1)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].move_speed = arg1 * 10;
}

void player_edit::on_damageModSpinBox_valueChanged(int arg1)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].damage_modifier = arg1;
}

void player_edit::on_canDoubleJumpCheckBox_toggled(bool checked)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].can_double_jump = checked;
}

void player_edit::on_CanAirDashCheckBox_toggled(bool checked)
{
    if (_loading == true) { return; }
     Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].can_air_dash = checked;
}

void player_edit::on_canShotDiagonal_toggled(bool checked)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].can_shot_diagonal = checked;
}
...
{
    if (_loading == true) { return; }
    sprintf(Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].face_filename, "%s", arg1.toStdString().c_str());
}
...
{
    if (_loading == true) { return; }
    Mediator::get_instance()->player_list_v3_1[Mediator::get_instance()->current_player].simultaneous_shots = arg1;
}
